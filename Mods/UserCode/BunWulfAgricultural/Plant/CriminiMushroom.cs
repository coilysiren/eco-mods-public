        ...
        public partial class CriminiMushroomSpecies
        {
            partial void ModsPostInitialize()
            {
                ...
                this.CapacityConstraints = new List<CapacityConstraint>()
                {
                        ...
                        new CapacityConstraint() { CapacityLayerName = "FertileGround", ConsumedCapacityPerPop = 0.36f },
                    
                        new CapacityConstraint() { CapacityLayerName = "ShrubSpace", ConsumedCapacityPerPop = 0.36f }
