...
namespace Eco.Mods.WorldLayers
{
    ...
    /// <summary>
    /// <para>Server side layer settings definition for the "Corn" plant layer setting.</para>
    ...
    public partial class PlantLayerSettingsCorn : PlantLayerSettings
    {
        ...
        {
            this.Name = "Corn";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Corn")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Corn"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Corn".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
...
namespace Eco.Mods.Organisms
{
    ...
    /// <summary>
    /// <para>Server side entity definition for the "Corn" entity.</para>
    ...
    public partial class Corn : PlantEntity
    {
        ...
        public partial class CornSpecies : PlantSpecies
        {
            public CornSpecies() : base()
            {
                ...
                this.Name = "Corn"; //noloc
                this.DisplayName = Localizer.DoStr("Corn"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.PlantsInGroup = new Range(12, 24);
                ...
                this.GenerationDefinitions.StartBiomes = "GrasslandBiome";
                ...
                // Visuals
                this.BlockType = typeof(CornBlock); // Defines the block type represented by this plant
                ...
                // fertilizers.
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Nitrogen", HalfSpeedConcentration = 0.4f, MaxResourceContent = 0.4f }); //noloc
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Phosphorus", HalfSpeedConcentration = 0.4f, MaxResourceContent = 0.4f }); //noloc
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Potassium", HalfSpeedConcentration = 0.1f, MaxResourceContent = 0.1f }); //noloc
