namespace BunWulfEducational
{
    ...
    [Ecopedia(
        "Items",
        "Research Papers",
        subPageName: "Librarian Culinary Research Paper Modern Item"
    )]
    public partial class LibrarianCulinaryResearchPaperModernRecipe : RecipeFamily
    {
        public LibrarianCulinaryResearchPaperModernRecipe()
        {
            ...
            recipe.Init(
                ...
                displayName: Localizer.DoStr("Librarian Culinary Research Paper Modern"),
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(BoiledSausageItem), 10, typeof(LibrarianSkill)),
                    new IngredientElement(typeof(BreadItem), 10, typeof(LibrarianSkill)),
