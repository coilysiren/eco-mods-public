...
namespace BunWulfEducational
{
    ...
    [Ecopedia("Items", "Research Papers", subPageName: "Librarian Dendrology Research Paper Advanced Item")]
    public partial class LibrarianDendrologyResearchPaperAdvancedRecipe : RecipeFamily
    {
        public LibrarianDendrologyResearchPaperAdvancedRecipe()
        {
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Librarian Dendrology Research Paper Advanced"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Librarian Dendrology Research Paper Advanced"), recipeType: typeof(LibrarianDendrologyResearchPaperAdvancedRecipe));
