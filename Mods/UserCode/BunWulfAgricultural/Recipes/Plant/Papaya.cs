...
namespace Eco.Mods.WorldLayers
{
    ...
    /// <summary>
    /// <para>Server side layer settings definition for the "Papaya" plant layer setting.</para>
    ...
    public partial class PlantLayerSettingsPapaya : PlantLayerSettings
    {
        public PlantLayerSettingsPapaya() : base()
        {
            ...
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Papaya")} Population"); // Sets the localized display name of the plant population layer
...
namespace Eco.Mods.Organisms
{
    ...
    /// <summary>
    /// <para>Server side entity definition for the "Papaya" entity.</para>
    ...
    public partial class Papaya : PlantEntity
    {
        ...
        public partial class PapayaSpecies : PlantSpecies
        {
            public PapayaSpecies() : base()
            {
                ...
                this.Name = "Papaya"; //noloc
                this.DisplayName = Localizer.DoStr("Papaya"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(35, 45);
                this.GenerationDefinitions.PlantsInGroup = new Range(2, 8);
                this.GenerationDefinitions.CountOfClusters = new Range(2, 8);
                this.GenerationDefinitions.RadiusOfGroup = new Range(6, 12);
                this.GenerationDefinitions.ClusterRadiusInWorldSize = new Range(0.05f, 0.22f);
                ...
                {
                    new SpeciesResource(typeof(PapayaItem), new Range(1, 3), 1),
                    new SpeciesResource(typeof(PapayaSeedItem), new Range(1, 2), 0.1f),
                };
                this.ResourceBonusAtGrowth = 0.9f;

                // Visuals
                this.BlockType = typeof(PapayaBlock); // Defines the block type represented by this plant
