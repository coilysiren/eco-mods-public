...
namespace Eco.Mods.WorldLayers
{
    ...
    /// <summary>
    /// <para>Server side layer settings definition for the "Huckleberry" plant layer setting.</para>
    ...
    public partial class PlantLayerSettingsHuckleberry : PlantLayerSettings
    {
        ...
        {
            this.Name = "Huckleberry";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Huckleberry")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Huckleberry"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Huckleberry".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
...
namespace Eco.Mods.Organisms
{
    ...
    /// <summary>
    /// <para>Server side entity definition for the "Huckleberry" entity.</para>
    ...
    public partial class Huckleberry : PlantEntity
    {
        ...
        public partial class HuckleberrySpecies : PlantSpecies
        {
            public HuckleberrySpecies() : base()
            {
                ...
                this.Name = "Huckleberry"; //noloc
                this.DisplayName = Localizer.DoStr("Huckleberry"); // Define our localized plant display name
                ...
                // Resources
                this.PostHarvestingGrowth = 0.5f; // After harvesting, we reset their growth percent to this value, 0 -1.  0 means kill the plant.
                ...
                // Visuals
                this.BlockType = typeof(HuckleberryBlock); // Defines the block type represented by this plant
                ...
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "SoilMoisture", HalfSpeedConcentration = 0.2f, MaxResourceContent = 0.05f }); //noloc
                ...
                this.CapacityConstraints.Add(new CapacityConstraint() { CapacityLayerName = "ShrubSpace", ConsumedCapacityPerPop = 5 }); //noloc
