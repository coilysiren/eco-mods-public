...
namespace Eco.Mods.WorldLayers
{
    ...
    /// <summary>
    /// <para>Server side layer settings definition for the "Rice" plant layer setting.</para>
    ...
    public partial class PlantLayerSettingsRice : PlantLayerSettings
    {
        ...
        {
            this.Name = "Rice";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Rice")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Rice"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Rice".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
...
namespace Eco.Mods.Organisms
{
    ...
    /// <summary>
    /// <para>Server side entity definition for the "Rice" entity.</para>
    ...
    public partial class Rice : PlantEntity
    {
        ...
        public partial class RiceSpecies : PlantSpecies
        {
            public RiceSpecies() : base()
            {
                ...
                this.Name = "Rice"; //noloc
                this.DisplayName = Localizer.DoStr("Rice"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.PlantsInGroup = new Range(8, 16);
                ...
                this.GenerationDefinitions.StartBiomes = "WetlandBiome";
                ...
                {
                    new SpeciesResource(typeof(RiceItem), new Range(1, 4), 1),
                };
                this.ResourceBonusAtGrowth = 0.9f;

                // Visuals
                this.BlockType = typeof(RiceBlock); // Defines the block type represented by this plant
                ...
                this.IdealMoistureRange = new Range(0.45f, 0.75f);
                this.IdealWaterRange = new Range(0, 0.1f);
                this.WaterExtremes = new Range(0, 0.2f);
                this.TemperatureExtremes = new Range(0.4f, 0.8f);
                this.MoistureExtremes = new Range(0.4f, 0.8f);
