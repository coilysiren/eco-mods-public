...
namespace Eco.Mods.WorldLayers
{
    ...
    /// <summary>
    /// <para>Server side layer settings definition for the "Pineapple" plant layer setting.</para>
    ...
    public partial class PlantLayerSettingsPineapple : PlantLayerSettings
    {
        public PlantLayerSettingsPineapple() : base()
        {
            ...
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Pineapple")} Population"); // Sets the localized display name of the plant population layer
...
namespace Eco.Mods.Organisms
{
    ...
    /// <summary>
    /// <para>Server side entity definition for the "Pineapple" entity.</para>
    ...
    public partial class Pineapple : PlantEntity
    {
        ...
        public partial class PineappleSpecies : PlantSpecies
        {
            public PineappleSpecies() : base()
            {
                ...
                this.Name = "Pineapple"; //noloc
                this.DisplayName = Localizer.DoStr("Pineapple"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(15, 25);
                this.GenerationDefinitions.PlantsInGroup = new Range(2, 5);
                ...
                // Visuals
                this.BlockType = typeof(PineappleBlock); // Defines the block type represented by this plant
