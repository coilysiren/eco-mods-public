...
namespace Eco.Mods.WorldLayers
{
    ...
    /// <summary>
    /// <para>Server side layer settings definition for the "Beets" plant layer setting.</para>
    ...
    public partial class PlantLayerSettingsBeets : PlantLayerSettings
    {
        ...
        {
            this.Name = "Beets";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Beets")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Beets"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Beets".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
...
namespace Eco.Mods.Organisms
{
    ...
    /// <summary>
    /// <para>Server side entity definition for the "Beets" entity.</para>
    ...
    public partial class Beets : PlantEntity
    {
        ...
        public partial class BeetsSpecies : PlantSpecies
        {
            public BeetsSpecies() : base()
            {
                ...
                this.Name = "Beets"; //noloc
                this.DisplayName = Localizer.DoStr("Beets"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.PlantsInGroup = new Range(8, 60);
                this.GenerationDefinitions.CountOfClusters = new Range(5, 8);
                this.GenerationDefinitions.RadiusOfGroup = new Range(4, 20);
                ...
                // Food
                this.CalorieValue = 6; // Defines the calorie value of the plant
                ...
                // Visuals
                this.BlockType = typeof(BeetsBlock); // Defines the block type represented by this plant
                ...
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Phosphorus", HalfSpeedConcentration = 0.2f, MaxResourceContent = 0.3f }); //noloc
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Potassium", HalfSpeedConcentration = 0.3f, MaxResourceContent = 0.4f }); //noloc
