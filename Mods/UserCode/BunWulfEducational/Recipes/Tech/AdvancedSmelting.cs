    ...
    public partial class LibrarianAdvancedSmeltingSkillBookRecipe : RecipeFamily
    {
        public LibrarianAdvancedSmeltingSkillBookRecipe()
        {
            ...
            recipe.Init(
                ...
                displayName: Localizer.DoStr("Librarian Advanced Smelting Skill Book"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(MetallurgyResearchPaperBasicItem), 20, typeof(LibrarianSkill)),
                    new IngredientElement(typeof(MetallurgyResearchPaperAdvancedItem), 20, typeof(LibrarianSkill)),
