...
namespace Eco.Mods.WorldLayers
{
    ...
    /// <summary>
    /// <para>Server side layer settings definition for the "BoleteMushroom" plant layer setting.</para>
    ...
    public partial class PlantLayerSettingsBoleteMushroom : PlantLayerSettings
    {
        ...
        {
            this.Name = "BoleteMushroom";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Bolete Mushroom")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Bolete Mushroom"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "BoleteMushroom".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
...
namespace Eco.Mods.Organisms
{
    ...
    /// <summary>
    /// <para>Server side entity definition for the "BoleteMushroom" entity.</para>
    ...
    public partial class BoleteMushroom : PlantEntity
    {
        ...
        public partial class BoleteMushroomSpecies : PlantSpecies
        {
            public BoleteMushroomSpecies() : base()
            {
                ...
                this.Name = "BoleteMushroom"; //noloc
                this.DisplayName = Localizer.DoStr("Bolete Mushroom"); // Define our localized plant display name
                ...
                // Food
                this.CalorieValue = 4; // Defines the calorie value of the plant
                ...
                {
                    new SpeciesResource(typeof(BoleteMushroomsItem), new Range(1, 3), 1),
                    new SpeciesResource(typeof(BoleteMushroomSporesItem), new Range(1, 2), 0.2f),
                };
                this.ResourceBonusAtGrowth = 0.9f;

                // Visuals
                this.BlockType = typeof(BoleteMushroomBlock); // Defines the block type represented by this plant
                ...
                this.IdealMoistureRange = new Range(0.45f, 0.85f);
                this.IdealWaterRange = new Range(0, 0.1f);
                this.WaterExtremes = new Range(0, 0.2f);
                this.TemperatureExtremes = new Range(0.2f, 0.8f);
                this.MoistureExtremes = new Range(0.4f, 0.9f);
