        ...
        public partial class HuckleberrySpecies
        {
            partial void ModsPostInitialize()
            {
                ...
                this.CapacityConstraints = new List<CapacityConstraint>()
                {
                        ...
                        new CapacityConstraint() { CapacityLayerName = "FertileGround", ConsumedCapacityPerPop = 0.5f },
                    
                        new CapacityConstraint() { CapacityLayerName = "ShrubSpace", ConsumedCapacityPerPop = 0.5f }
