...
namespace Eco.Mods.WorldLayers
{
    ...
    /// <summary>
    /// <para>Server side layer settings definition for the "Pumpkin" plant layer setting.</para>
    ...
    public partial class PlantLayerSettingsPumpkin : PlantLayerSettings
    {
        ...
        {
            this.Name = "Pumpkin";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Pumpkin")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Pumpkin"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Pumpkin".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
...
namespace Eco.Mods.Organisms
{
    ...
    /// <summary>
    /// <para>Server side entity definition for the "Pumpkin" entity.</para>
    ...
    public partial class Pumpkin : PlantEntity
    {
        ...
        public partial class PumpkinSpecies : PlantSpecies
        {
            public PumpkinSpecies() : base()
            {
                ...
                this.Name = "Pumpkin"; //noloc
                this.DisplayName = Localizer.DoStr("Pumpkin"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(20, 40);
                ...
                // Visuals
                this.BlockType = typeof(PumpkinBlock); // Defines the block type represented by this plant
