...
namespace Eco.Mods.TechTree
{
    ...
    [Ecopedia("Items", "Research Papers", subPageName: "Librarian Culinary Research Paper Basic Item")]
    public partial class LibrarianCulinaryResearchPaperBasicRecipe : RecipeFamily
    {
        public LibrarianCulinaryResearchPaperBasicRecipe()
        {
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Librarian Culinary Research Paper Basic"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Librarian Culinary Research Paper Basic"), recipeType: typeof(LibrarianCulinaryResearchPaperBasicRecipe));
