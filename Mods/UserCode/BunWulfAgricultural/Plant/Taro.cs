        ...
        public partial class TaroSpecies
        {
            partial void ModsPostInitialize()
            {
                ...
                this.CapacityConstraints = new List<CapacityConstraint>()
                {
                        ...
                        new CapacityConstraint() { CapacityLayerName = "FertileGround", ConsumedCapacityPerPop = 0.25f },
                    
                        new CapacityConstraint() { CapacityLayerName = "ShrubSpace", ConsumedCapacityPerPop = 0.25f }
