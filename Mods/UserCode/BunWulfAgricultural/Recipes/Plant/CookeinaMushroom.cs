...
namespace Eco.Mods.WorldLayers
{
    ...
    /// <summary>
    /// <para>Server side layer settings definition for the "CookeinaMushroom" plant layer setting.</para>
    ...
    public partial class PlantLayerSettingsCookeinaMushroom : PlantLayerSettings
    {
        ...
        {
            this.Name = "CookeinaMushroom";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Cookeina Mushroom")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Cookeina Mushroom"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "CookeinaMushroom".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
...
namespace Eco.Mods.Organisms
{
    ...
    /// <summary>
    /// <para>Server side entity definition for the "CookeinaMushroom" entity.</para>
    ...
    public partial class CookeinaMushroom : PlantEntity
    {
        ...
        public partial class CookeinaMushroomSpecies : PlantSpecies
        {
            public CookeinaMushroomSpecies() : base()
            {
                ...
                this.Name = "CookeinaMushroom"; //noloc
                this.DisplayName = Localizer.DoStr("Cookeina Mushroom"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(20, 50);
                this.GenerationDefinitions.PlantsInGroup = new Range(3, 11);
                ...
                // Visuals
                this.BlockType = typeof(CookeinaMushroomBlock); // Defines the block type represented by this plant
