        ...
        public partial class WheatSpecies
        {
            partial void ModsPostInitialize()
            {
                ...
                this.CapacityConstraints = new List<CapacityConstraint>()
                {
                        ...
                        new CapacityConstraint() { CapacityLayerName = "FertileGround", ConsumedCapacityPerPop = 0.4f },
                    
                        new CapacityConstraint() { CapacityLayerName = "ShrubSpace", ConsumedCapacityPerPop = 0.4f }
