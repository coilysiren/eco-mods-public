...
namespace Eco.Mods.WorldLayers
{
    ...
    /// <summary>
    /// <para>Server side layer settings definition for the "PricklyPear" plant layer setting.</para>
    ...
    public partial class PlantLayerSettingsPricklyPear : PlantLayerSettings
    {
        public PlantLayerSettingsPricklyPear() : base()
        {
            ...
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Prickly Pear")} Population"); // Sets the localized display name of the plant population layer
...
namespace Eco.Mods.Organisms
{
    ...
    /// <summary>
    /// <para>Server side entity definition for the "PricklyPear" entity.</para>
    ...
    public partial class PricklyPear : PlantEntity
    {
        ...
        public partial class PricklyPearSpecies : PlantSpecies
        {
            public PricklyPearSpecies() : base()
            {
                ...
                this.Name = "PricklyPear"; //noloc
                this.DisplayName = Localizer.DoStr("Prickly Pear"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(40, 60);
                ...
                // Food
                this.CalorieValue = 10; // Defines the calorie value of the plant
                ...
                // Visuals
                this.BlockType = typeof(PricklyPearBlock); // Defines the block type represented by this plant
