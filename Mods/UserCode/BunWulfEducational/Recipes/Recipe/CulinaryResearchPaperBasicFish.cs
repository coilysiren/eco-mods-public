...
namespace Eco.Mods.TechTree
{
    ...
    public partial class LibrarianCulinaryResearchPaperBasicFishRecipe : RecipeFamily
    {
        public LibrarianCulinaryResearchPaperBasicFishRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(LibrarianCulinaryResearchPaperBasicFishRecipe), start: 1, skillType: typeof(LibrarianSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Librarian Culinary Research Paper Basic Fish"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Librarian Culinary Research Paper Basic Fish"), recipeType: typeof(LibrarianCulinaryResearchPaperBasicFishRecipe));
