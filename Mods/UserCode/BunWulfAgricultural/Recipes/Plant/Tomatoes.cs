...
namespace Eco.Mods.WorldLayers
{
    ...
    /// <summary>
    /// <para>Server side layer settings definition for the "Tomatoes" plant layer setting.</para>
    ...
    public partial class PlantLayerSettingsTomatoes : PlantLayerSettings
    {
        public PlantLayerSettingsTomatoes() : base()
        {
            ...
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Tomatoes")} Population"); // Sets the localized display name of the plant population layer
...
namespace Eco.Mods.Organisms
{
    ...
    /// <summary>
    /// <para>Server side entity definition for the "Tomatoes" entity.</para>
    ...
    public partial class Tomatoes : PlantEntity
    {
        ...
        public partial class TomatoesSpecies : PlantSpecies
        {
            public TomatoesSpecies() : base()
            {
                ...
                this.Name = "Tomatoes"; //noloc
                this.DisplayName = Localizer.DoStr("Tomatoes"); // Define our localized plant display name
                ...
                // Visuals
                this.BlockType = typeof(TomatoesBlock); // Defines the block type represented by this plant
