...
namespace Eco.Mods.WorldLayers
{
    ...
    /// <summary>
    /// <para>Server side layer settings definition for the "Fern" plant layer setting.</para>
    ...
    public partial class PlantLayerSettingsFern : PlantLayerSettings
    {
        ...
        {
            this.Name = "Fern";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Fern")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Fern"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Fern".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
...
namespace Eco.Mods.Organisms
{
    ...
    /// <summary>
    /// <para>Server side entity definition for the "Fern" entity.</para>
    ...
    public partial class Fern : PlantEntity
    {
        ...
        public partial class FernSpecies : PlantSpecies
        {
            public FernSpecies() : base()
            {
                ...
                this.Name = "Fern"; //noloc
                this.DisplayName = Localizer.DoStr("Fern"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.PlantsInGroup = new Range(4, 18);
                this.GenerationDefinitions.CountOfClusters = new Range(6, 12);
                this.GenerationDefinitions.RadiusOfGroup = new Range(6, 12);
                this.GenerationDefinitions.ClusterRadiusInWorldSize = new Range(0.25f, 0.44f);

                // Food
                this.CalorieValue = 2; // Defines the calorie value of the plant
                ...
                // Visuals
                this.BlockType = typeof(FernBlock); // Defines the block type represented by this plant
