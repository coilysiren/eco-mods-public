namespace EcoNil
{
    ...
    public partial class CloudSeederObject : WorldObject, IRepresentsItem
    {
        public override TableTextureMode TableTexture => TableTextureMode.Metal;
        public override LocString DisplayName => Localizer.DoStr("Cloud Seeder");
        public virtual Type RepresentedItemType => typeof(CloudSeederItem);
        ...
        static CloudSeederObject()
        {
            AddOccupancy<CloudSeederObject>(
