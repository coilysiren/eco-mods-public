...
namespace Eco.Mods.WorldLayers
{
    ...
    /// <summary>
    /// <para>Server side layer settings definition for the "Taro" plant layer setting.</para>
    ...
    public partial class PlantLayerSettingsTaro : PlantLayerSettings
    {
        ...
        {
            this.Name = "Taro";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Taro")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Taro"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Taro".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
...
namespace Eco.Mods.Organisms
{
    ...
    /// <summary>
    /// <para>Server side entity definition for the "Taro" entity.</para>
    ...
    public partial class Taro : PlantEntity
    {
        ...
        public partial class TaroSpecies : PlantSpecies
        {
            public TaroSpecies() : base()
            {
                ...
                this.Name = "Taro"; //noloc
                this.DisplayName = Localizer.DoStr("Taro"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(12, 20);
                this.GenerationDefinitions.PlantsInGroup = new Range(3, 12);
                ...
                {
                    new SpeciesResource(typeof(TaroRootItem), new Range(1, 3), 1),
                    new SpeciesResource(typeof(TaroSeedItem), new Range(1, 2), 0.15f),
                };
                this.ResourceBonusAtGrowth = 0.9f;

                // Visuals
                this.BlockType = typeof(TaroBlock); // Defines the block type represented by this plant
