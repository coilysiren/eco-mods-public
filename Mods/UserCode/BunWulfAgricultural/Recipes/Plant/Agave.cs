...
namespace Eco.Mods.WorldLayers
{
    ...
    /// <summary>
    /// <para>Server side layer settings definition for the "Agave" plant layer setting.</para>
    ...
    public partial class PlantLayerSettingsAgave : PlantLayerSettings
    {
        ...
        {
            this.Name = "Agave";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Agave")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Agave"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Agave".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
...
namespace Eco.Mods.Organisms
{
    ...
    /// <summary>
    /// <para>Server side entity definition for the "Agave" entity.</para>
    ...
    public partial class Agave : PlantEntity
    {
        ...
        public partial class AgaveSpecies : PlantSpecies
        {
            public AgaveSpecies() : base()
            {
                ...
                this.Name = "Agave"; //noloc
                this.DisplayName = Localizer.DoStr("Agave"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.ChanceToBeSpawnOutsideOfGroup = 0.05f;
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(40, 80);
                this.GenerationDefinitions.PlantsInGroup = new Range(6, 20);
                this.GenerationDefinitions.CountOfClusters = new Range(3, 7);
                this.GenerationDefinitions.RadiusOfGroup = new Range(2, 6);
                this.GenerationDefinitions.ClusterRadiusInWorldSize = new Range(0.05f, 0.14f);
                this.GenerationDefinitions.StartBiomes = "DesertBiome";
                ...
                {
                    new SpeciesResource(typeof(AgaveLeavesItem), new Range(1, 3), 1),
                    new SpeciesResource(typeof(AgaveSeedItem), new Range(1, 2), 0.2f),
                };
                this.ResourceBonusAtGrowth = 0.9f;

                // Visuals
                this.BlockType = typeof(AgaveBlock); // Defines the block type represented by this plant
