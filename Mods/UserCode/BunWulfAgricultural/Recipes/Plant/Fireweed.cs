...
namespace Eco.Mods.WorldLayers
{
    ...
    /// <summary>
    /// <para>Server side layer settings definition for the "Fireweed" plant layer setting.</para>
    ...
    public partial class PlantLayerSettingsFireweed : PlantLayerSettings
    {
        ...
        {
            this.Name = "Fireweed";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Fireweed")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Fireweed"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Fireweed".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
...
namespace Eco.Mods.Organisms
{
    ...
    /// <summary>
    /// <para>Server side entity definition for the "Fireweed" entity.</para>
    ...
    public partial class Fireweed : PlantEntity
    {
        ...
        public partial class FireweedSpecies : PlantSpecies
        {
            public FireweedSpecies() : base()
            {
                ...
                this.Name = "Fireweed"; //noloc
                this.DisplayName = Localizer.DoStr("Fireweed"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.PlantsInGroup = new Range(8, 20);
                ...
                this.GenerationDefinitions.StartBiomes = "TundraBiome";
                ...
                // Visuals
                this.BlockType = typeof(FireweedBlock); // Defines the block type represented by this plant
                ...
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Phosphorus", HalfSpeedConcentration = 0.15f, MaxResourceContent = 0.3f }); //noloc
                ...
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "SoilMoisture", HalfSpeedConcentration = 0.05f, MaxResourceContent = 0.1f }); //noloc
