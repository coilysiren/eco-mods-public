...
namespace BunWulfEducational
{
    ...
    public partial class LibrarianCulinaryResearchPaperBasicMeatRecipe : RecipeFamily
    {
        public LibrarianCulinaryResearchPaperBasicMeatRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(LibrarianCulinaryResearchPaperBasicMeatRecipe), start: 1, skillType: typeof(LibrarianSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Librarian Culinary Research Paper Basic Meat"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Librarian Culinary Research Paper Basic Meat"), recipeType: typeof(LibrarianCulinaryResearchPaperBasicMeatRecipe));
