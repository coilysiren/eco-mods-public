namespace BunWulfEducational
{
    ...
    [Ecopedia(
        "Items",
        "Research Papers",
        subPageName: "Librarian Dendrology Research Paper Basic Item"
    )]
    public partial class LibrarianDendrologyResearchPaperBasicRecipe : RecipeFamily
    {
        public LibrarianDendrologyResearchPaperBasicRecipe()
        {
            ...
            recipe.Init(
                ...
                displayName: Localizer.DoStr("Librarian Dendrology Research Paper Basic"),
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement("Wood", 20, typeof(LibrarianSkill)),
                },
