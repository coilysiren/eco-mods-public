...
namespace Eco.Mods.WorldLayers
{
    ...
    /// <summary>
    /// <para>Server side layer settings definition for the "CriminiMushroom" plant layer setting.</para>
    ...
    public partial class PlantLayerSettingsCriminiMushroom : PlantLayerSettings
    {
        ...
        {
            this.Name = "CriminiMushroom";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Crimini Mushroom")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Crimini Mushroom"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "CriminiMushroom".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
...
namespace Eco.Mods.Organisms
{
    ...
    /// <summary>
    /// <para>Server side entity definition for the "CriminiMushroom" entity.</para>
    ...
    public partial class CriminiMushroom : PlantEntity
    {
        ...
        public partial class CriminiMushroomSpecies : PlantSpecies
        {
            public CriminiMushroomSpecies() : base()
            {
                ...
                this.Name = "CriminiMushroom"; //noloc
                this.DisplayName = Localizer.DoStr("Crimini Mushroom"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.PlantsInGroup = new Range(3, 7);
                ...
                // Visuals
                this.BlockType = typeof(CriminiMushroomBlock); // Defines the block type represented by this plant
                ...
                this.CapacityConstraints.Add(new CapacityConstraint() { CapacityLayerName = "FertileGround", ConsumedCapacityPerPop = 3.6f }); //noloc
                this.CapacityConstraints.Add(new CapacityConstraint() { CapacityLayerName = "ShrubSpace", ConsumedCapacityPerPop = 3.6f }); //noloc

                this.BlanketSpawnPercent = 0.8f;
                this.IdealTemperatureRange = new Range(0.45f, 0.75f);
                this.IdealMoistureRange = new Range(0.35f, 0.75f);
                this.IdealWaterRange = new Range(0, 0.1f);
                this.WaterExtremes = new Range(0, 0.2f);
                this.TemperatureExtremes = new Range(0.4f, 0.8f);
                this.MoistureExtremes = new Range(0.3f, 0.9f);
